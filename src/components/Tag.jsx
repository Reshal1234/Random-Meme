...
const Tag = () => {
  ...
  return (
    <div className="w-1/2 bg-blue-500 mx-auto rounded-lg border border-black flex flex-col items-center gap-y-5 mt-[15px] mb-[40px]">
      ...
      <button
        ...
        className="w-10/12 bg-white text-xl py-2 rounded-lg font-bold mb-[25px]"
      >
        Generate
      </button>
    </div>
